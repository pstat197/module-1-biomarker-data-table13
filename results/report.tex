...
\begin{center}
\includegraphics[width=1.35417in,height=\textheight]{images/q2top13-02.png}
\end{center}
...
\begin{center}
\includegraphics[width=5.20833in,height=\textheight]{images/q2boxplot-03.png}
\end{center}
...
\begin{center}
\includegraphics[width=1.5625in,height=\textheight]{images/q2proptest-01.png}
\end{center}
...
comparison\_data \textless- data.frame( Metric = c(``Accuracy'',
``Sensitivity'', ``Specificity'', ``AUROC''), InClassIntersection =
c(0.774, 0.812, 0.733, 0.883), PureLASSO = c(0.767, 0.750, 0.933,
0.858), ChangeVsBaseline = c(``\(\\approx 1\\%\) decrease'',
``\(7.6\\%\) decrease'', ``\(27.3\\%\) increase'', ``\(\\approx 2.8\\%\)
decrease''), KeyInsight = c(``Comparable overall accuracy.'', ``Reduced
ability to correctly identify ASD cases.'', ``Vastly improved
performance in ruling out controls.'', ``Lower overall discrimination
ability.'') )
...
{\centering \includegraphics[width=0.5\textwidth,height=\textheight]{../images/Q4PureLasso.png}
